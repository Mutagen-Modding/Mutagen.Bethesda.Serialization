...
internal static class SomeObject_Serialization
{
    ...
    {
        metaData.Cancel.ThrowIfCancellationRequested();
        kernel.WriteUInt16(writer, "FormVersion", item.FormVersion, metaData.Constants.DefaultFormVersion ?? 0);
    }
        ...
        SerializationMetaData metaData)
    {
        ...
        if (!EqualityComparer<ushort>.Default.Equals(item.FormVersion, metaData.Constants.DefaultFormVersion ?? 0)) return true;
        return false;
    }
        ...
        where TReadObject : IContainStreamPackage
    {
        ...
        {
            case "FormVersion":
                obj.FormVersion = SerializationHelper.StripNull(kernel.ReadUInt16(reader), name: "FormVersion");
                break;
            default:
                kernel.Skip(reader);
                break;

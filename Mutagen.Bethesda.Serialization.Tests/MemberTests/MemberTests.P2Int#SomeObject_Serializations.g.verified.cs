...
internal static class SomeObject_Serialization
{
        ...
        where TReadObject : IContainStreamPackage
    {
        ...
        {
            case "SomeMember0":
                obj.SomeMember0 = SerializationHelper.StripNull(kernel.ReadP2Int(reader), name: "SomeMember0");
                break;
            case "SomeMember1":
            ...
            case "SomeMember2":
                ...
                break;
            case "SomeMember3":
                obj.SomeMember3 = SerializationHelper.StripNull(kernel.ReadP2Int(reader), name: "SomeMember3");
                break;
            case "SomeMember4":

...
public interface ITestMajorRecordWithNested : ITestMajorRecordWithNestedGetter, IMajorRecordInternal
{
    new string String { get; set; }

    new ExtendedList<TestMajorRecord> NestedRecords { get; }
}

public interface ITestMajorRecordWithNestedGetter : ILoquiObjectGetter, IMajorRecordGetter
{
    string String { get; }

    IReadOnlyList<ITestMajorRecordGetter> NestedRecords { get; }
}

public class TestMajorRecordWithNested : ITestMajorRecordWithNested, IEquatable<TestMajorRecordWithNested>
{
    ...
    public ExtendedList<TestMajorRecord> NestedRecords { get; set; } = new();
    IReadOnlyList<ITestMajorRecordGetter> ITestMajorRecordWithNestedGetter.NestedRecords => this.NestedRecords;

    public TestMajorRecordWithNested(FormKey i, string s)
    {
        String = s;
        FormKey = i;
    }
    ...
    public bool Equals(TestMajorRecordWithNested? other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals((TestMajorRecordWithNested)obj);
    }
}
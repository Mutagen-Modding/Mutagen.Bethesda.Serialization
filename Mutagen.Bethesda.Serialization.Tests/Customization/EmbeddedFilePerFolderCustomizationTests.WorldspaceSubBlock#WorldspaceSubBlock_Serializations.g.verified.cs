//HintName: WorldspaceSubBlock_Serializations.g.cs
using Loqui;
...
internal static class WorldspaceSubBlock_Serialization
{
    public static async Task Serialize<TKernel, TWriteObject>(
        TWriteObject writer,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.IWorldspaceSubBlockGetter item,
        ...
        SerializationMetaData metaData)
    {
        ...
        if (item.MajorRecord.Count > 0) return true;
        return false;
    }

    public static async Task<Mutagen.Bethesda.Serialization.SourceGenerator.Tests.WorldspaceSubBlock> Deserialize<TReadObject>(
        TReadObject reader,
    ...
    {
        metaData.Cancel.ThrowIfCancellationRequested();
        var obj = new Mutagen.Bethesda.Serialization.SourceGenerator.Tests.WorldspaceSubBlock();
    ...
    public static async Task DeserializeSingleFieldInto<TReadObject>(
        TReadObject reader,
        ISerializationReaderKernel<TReadObject> kernel,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.IWorldspaceSubBlock obj,
        SerializationMetaData metaData,
        string name)
        where TReadObject : IContainStreamPackage
    {

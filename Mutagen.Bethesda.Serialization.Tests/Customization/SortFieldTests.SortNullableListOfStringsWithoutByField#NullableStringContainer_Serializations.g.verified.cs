//HintName: NullableStringContainer_Serializations.g.cs
using Loqui;
...
internal static class NullableStringContainer_Serialization
{
    public static async Task Serialize<TKernel, TWriteObject>(
        TWriteObject writer,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.INullableStringContainerGetter item,
    ...
    public static async Task<Mutagen.Bethesda.Serialization.SourceGenerator.Tests.NullableStringContainer> Deserialize<TReadObject>(
        TReadObject reader,
    ...
    {
        metaData.Cancel.ThrowIfCancellationRequested();
        var obj = new Mutagen.Bethesda.Serialization.SourceGenerator.Tests.NullableStringContainer();
    ...
    public static async Task DeserializeSingleFieldInto<TReadObject>(
        TReadObject reader,
        ISerializationReaderKernel<TReadObject> kernel,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.INullableStringContainer obj,
        SerializationMetaData metaData,
        string name)
        where TReadObject : IContainStreamPackage
    {

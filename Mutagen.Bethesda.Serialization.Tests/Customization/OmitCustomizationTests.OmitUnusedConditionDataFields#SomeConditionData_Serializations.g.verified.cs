//HintName: SomeConditionData_Serializations.g.cs
using Loqui;
...
internal static class SomeConditionData_Serialization
{
    public static async Task Serialize<TKernel, TWriteObject>(
        TWriteObject writer,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.ISomeConditionDataGetter item,
    ...
    public static async Task<Mutagen.Bethesda.Serialization.SourceGenerator.Tests.SomeConditionData> Deserialize<TReadObject>(
        TReadObject reader,
    ...
    {
        metaData.Cancel.ThrowIfCancellationRequested();
        var obj = new Mutagen.Bethesda.Serialization.SourceGenerator.Tests.SomeConditionData();
    ...
    public static async Task DeserializeSingleFieldInto<TReadObject>(
        TReadObject reader,
        ISerializationReaderKernel<TReadObject> kernel,
        Mutagen.Bethesda.Serialization.SourceGenerator.Tests.ISomeConditionData obj,
        SerializationMetaData metaData,
        string name)
        where TReadObject : IContainStreamPackage
    {

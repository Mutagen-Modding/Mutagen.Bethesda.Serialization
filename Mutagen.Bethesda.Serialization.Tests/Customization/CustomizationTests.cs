...
public class CustomizationTests : ATestsBase
{
    ...
    [Fact]
    public Task FilePerRecordWithList()
    {
        var sb = new StructuredStringBuilder();
    ...
    [Fact]
    public Task FilePerRecordWithListEmbedded()
    {
        var sb = new StructuredStringBuilder();
    ...
    [Fact]
    public Task FilePerRecordMajorRecord()
    {
        var sb = new StructuredStringBuilder();
    ...
    [Fact]
    public Task FilePerRecordMajorRecordEmbedded()
    {
        var sb = new StructuredStringBuilder();

...
internal static class SomeObject_Serialization
{
        ...
        ISerializationReaderKernel<TReadObject> kernel)
    {
        while (kernel.TryGetNextField(reader, out var name))
        {
            ...
            {
                case "SomeMember0":
                    item.SomeMember0 = kernel.ReadString(reader);
                case "SomeMember1":
                    item.SomeMember1 = kernel.ReadString(reader);
                case "SomeMember2":
                    item.SomeMember2 = kernel.ReadString(reader);
                case "SomeMember3":
                    item.SomeMember3 = kernel.ReadString(reader);
                case "SomeMember4":
                    item.SomeMember4 = kernel.ReadString(reader);
                case "SomeMember5":
                    item.SomeMember5 = kernel.ReadString(reader);
                case "SomeMember6":
                    item.SomeMember6 = kernel.ReadString(reader);
                case "SomeMember7":
                    item.SomeMember7 = kernel.ReadString(reader);
                case "SomeMember8":
                    item.SomeMember8 = kernel.ReadString(reader);
                case "SomeMember9":
                    item.SomeMember9 = kernel.ReadString(reader);
                case "SomeMember10":
                    item.SomeMember10 = kernel.ReadString(reader);
                case "SomeMember11":
                    item.SomeMember11 = kernel.ReadString(reader);
                default:
                    break;
            }
        }

...
internal static class SomeObject_Serialization
{
        ...
        where TReadObject : IContainStreamPackage
    {
        ...
        {
            case "SomeMember0":
                obj.SomeMember0 = SerializationHelper.StripNull(kernel.ReadUInt64(reader), name: "SomeMember0");
                break;
            case "SomeMember1":
                obj.SomeMember1 = SerializationHelper.StripNull(kernel.ReadUInt64(reader), name: "SomeMember1");
                break;
            case "SomeMember2":
            ...
            case "SomeMember5":
                ...
                break;
            case "SomeMember6":
                obj.SomeMember6 = SerializationHelper.StripNull(kernel.ReadUInt64(reader), name: "SomeMember6");
                break;
            case "SomeMember7":
                obj.SomeMember7 = SerializationHelper.StripNull(kernel.ReadUInt64(reader), name: "SomeMember7");
                break;
            case "SomeMember8":

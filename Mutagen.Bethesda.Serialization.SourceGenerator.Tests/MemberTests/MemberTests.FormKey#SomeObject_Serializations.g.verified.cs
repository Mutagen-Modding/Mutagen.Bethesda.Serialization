...
internal static class SomeObject_Serialization
{
        ...
        SerializationMetaData metaData)
    {
        while (kernel.TryGetNextField(reader, out var name))
        {
            ...
            {
                case "SomeMember0":
                    obj.SomeMember0 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember1":
                    obj.SomeMember1 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember2":
                    obj.SomeMember2 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember3":
                    obj.SomeMember3 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember4":
                    obj.SomeMember4 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember5":
                    obj.SomeMember5 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember6":
                    obj.SomeMember6 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember7":
                    obj.SomeMember7 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember8":
                    obj.SomeMember8 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember9":
                    obj.SomeMember9 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember10":
                    obj.SomeMember10 = kernel.ReadFormKey(reader);
                    break;
                case "SomeMember11":
                    obj.SomeMember11 = kernel.ReadFormKey(reader);
                    break;
                default:
                    break;
            }

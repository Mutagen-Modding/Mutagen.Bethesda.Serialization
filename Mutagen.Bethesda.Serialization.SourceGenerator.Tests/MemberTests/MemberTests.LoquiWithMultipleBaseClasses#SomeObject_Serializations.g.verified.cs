...
internal static class SomeObject_Serialization
{
        ...
        string name)
    {
        ...
        {
            case "MyLoqui":
                obj.MyLoqui = kernel.ReadLoqui(reader, metaData, static (r, k, m) => Mutagen.Bethesda.Serialization.SourceGenerator.Tests.AbstractBaseLoqui_Serialization.DeserializeWithCheck<TReadObject>(r, k, m));
                break;
            default:
                break;
        }

...
internal static class SomeObject_Serialization
{
        ...
        where TReadObject : IContainStreamPackage
    {
        ...
        {
            case "SomeMember0":
                obj.SomeMember0 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember0");
                break;
            case "SomeMember1":
                obj.SomeMember1 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember1");
                break;
            case "SomeMember2":
                obj.SomeMember2 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember2");
                break;
            case "SomeMember3":
                obj.SomeMember3 = kernel.ReadInt8(reader);
                break;
            case "SomeMember4":
                obj.SomeMember4 = kernel.ReadInt8(reader);
                break;
            case "SomeMember5":
                obj.SomeMember5 = kernel.ReadInt8(reader);
                break;
            case "SomeMember6":
                obj.SomeMember6 = kernel.ReadInt8(reader);
                break;
            case "SomeMember7":
                obj.SomeMember7 = kernel.ReadInt8(reader);
                break;
            case "SomeMember8":
                obj.SomeMember8 = kernel.ReadInt8(reader);
                break;
            case "SomeMember9":
                obj.SomeMember9 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember9");
                break;
            case "SomeMember10":
                obj.SomeMember10 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember10");
                break;
            case "SomeMember11":
                obj.SomeMember11 = SerializationHelper.StripNull(kernel.ReadInt8(reader), name: "SomeMember11");
                break;
            case "SomeMember12":
                obj.SomeMember12 = kernel.ReadInt8(reader);
                break;
            case "SomeMember13":
                obj.SomeMember13 = kernel.ReadInt8(reader);
                break;
            case "SomeMember14":
                obj.SomeMember14 = kernel.ReadInt8(reader);
                break;
            case "SomeMember15":
                obj.SomeMember15 = kernel.ReadInt8(reader);
                break;
            case "SomeMember16":
                obj.SomeMember16 = kernel.ReadInt8(reader);
                break;
            case "SomeMember17":
                obj.SomeMember17 = kernel.ReadInt8(reader);
                break;
            default:
                break;
        }

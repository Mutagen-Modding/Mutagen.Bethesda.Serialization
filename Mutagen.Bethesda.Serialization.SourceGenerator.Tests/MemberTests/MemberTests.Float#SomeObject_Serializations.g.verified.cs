...
internal static class SomeObject_Serialization
{
        ...
        SerializationMetaData metaData)
    {
        while (kernel.TryGetNextField(reader, out var name))
        {
            ...
            {
                case "SomeMember0":
                    obj.SomeMember0 = kernel.ReadFloat(reader);
                    break;
                case "SomeMember1":
                    obj.SomeMember1 = kernel.ReadFloat(reader);
                    break;
                case "SomeMember2":
                ...
                case "SomeMember5":
                    ...
                    break;
                case "SomeMember6":
                    obj.SomeMember6 = kernel.ReadFloat(reader);
                    break;
                case "SomeMember7":
                    obj.SomeMember7 = kernel.ReadFloat(reader);
                    break;
                case "SomeMember8":

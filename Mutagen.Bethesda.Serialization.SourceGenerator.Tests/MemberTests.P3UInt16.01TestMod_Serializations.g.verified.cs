...
internal static class TestMod_Serialization
{
        ...
        where TKernel : ISerializationWriterKernel<TWriteObject>, new()
    {
        ...
        kernel.WriteP3UInt16(writer, "SomeMember3", item.SomeMember3, Mutagen.Bethesda.Serialization.SourceGenerator.Tests.ITestModGetter.SomeMember3Default);
        kernel.WriteP3UInt16(writer, "SomeMember4", item.SomeMember4, Mutagen.Bethesda.Serialization.SourceGenerator.Tests.ITestModGetter.SomeMember4Default);

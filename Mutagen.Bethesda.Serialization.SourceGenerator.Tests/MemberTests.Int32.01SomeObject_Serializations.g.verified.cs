...
internal static class SomeObject_Serialization
{
        ...
        ISerializationReaderKernel<TReadObject> kernel)
    {
        while (kernel.TryGetNextField(out var name))
        {
            ...
            {
                case: "SomeMember0":
                    item.SomeMember0 = kernel.ReadInt32(writer);
                case: "SomeMember1":
                    item.SomeMember1 = kernel.ReadInt32(writer);
                case: "SomeMember2":
                    item.SomeMember2 = kernel.ReadInt32(writer);
                case: "SomeMember3":
                    item.SomeMember3 = kernel.ReadInt32(writer);
                case: "SomeMember4":
                    item.SomeMember4 = kernel.ReadInt32(writer);
                case: "SomeMember5":
                    item.SomeMember5 = kernel.ReadInt32(writer);
                case: "SomeMember6":
                    item.SomeMember6 = kernel.ReadInt32(writer);
                case: "SomeMember7":
                    item.SomeMember7 = kernel.ReadInt32(writer);
                case: "SomeMember8":
                    item.SomeMember8 = kernel.ReadInt32(writer);
                case: "SomeMember9":
                    item.SomeMember9 = kernel.ReadInt32(writer);
                case: "SomeMember10":
                    item.SomeMember10 = kernel.ReadInt32(writer);
                case: "SomeMember11":
                    item.SomeMember11 = kernel.ReadInt32(writer);
                default:
                    break;
            }
        }

...
internal static class SomeObject_Serialization
{
        ...
        SerializationMetaData metaData)
    {
        while (kernel.TryGetNextField(reader, out var name))
        {
            ...
            {
                case "SomeMember0":
                    obj.SomeMember0 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember1":
                    obj.SomeMember1 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember2":
                    obj.SomeMember2 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember3":
                ...
                case "SomeMember8":
                    ...
                    break;
                case "SomeMember9":
                    obj.SomeMember9 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember10":
                    obj.SomeMember10 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember11":
                    obj.SomeMember11 = kernel.ReadInt8(reader);
                    break;
                case "SomeMember12":
